...
angular.module('taamineApp')
    .controller('MesPropositionEntrepriseController', function ($scope, $state, MesPropositionEntreprise,Principal, User) {

        $scope.propositions = [];
        $scope.loadAll = function(id) {
        	console.log("laoding proposition entreprise");
        	MesPropositionEntreprise.query({id:id},function(result) {
